...
<style scoped>
/* Page 6 - Blanc froid moderne */
.display-page { min-height: 100vh; height: 100vh; background: #F8FAFC; position: relative; overflow: hidden; }
...
.fullscreen-btn { position: fixed; top: 20px; left: 20px; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; background: #E2E8F0; border: 2px solid #94A3B8; border-radius: 12px; cursor: pointer; z-index: 100; }
.fullscreen-btn svg { width: 24px; height: 24px; color: #475569; }
.fullscreen-btn:hover { background: #CBD5E1; }
...
.gala-title { font-size: clamp(16px, 2vw, 28px); color: #64748B; font-weight: 700; letter-spacing: 4px; }
.gala-org { font-size: clamp(24px, 3vw, 44px); color: #CA8A04; font-weight: 900; letter-spacing: 5px; margin-top: 5px; }
...
.section-header { display: flex; align-items: center; justify-content: center; margin-bottom: 1.5vh; padding-bottom: 1vh; border-bottom: 3px solid #CA8A04; }
.section-header span { font-size: clamp(18px, 2vw, 32px); font-weight: 900; color: #CA8A04; letter-spacing: 3px; }
