...
function updateLighting(): void {
  ...
  // Using :scope > to select only direct children of svg
  ...
  // We want bottom to top, so sort DESCENDING
...
// Generate ember particles that rise from the base
...
.ember {
  ...
  width: 3px;
  height: 3px;
  background: radial-gradient(circle, #FFD54F 0%, #FF9800 50%, #FF5722 100%);
  border-radius: 50%;
